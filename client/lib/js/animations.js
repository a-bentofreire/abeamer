...
(function (ABeamer) {
    ...
    function _parseMotion(handler, params, exprMotionHandler, mapper, args) {
        var func;
        params = params || {};
    ...
    var _AbstractWorkAnimation = /** @class */ (function () {
        ...
        _AbstractWorkAnimation.prototype.assignValues = function (acp, story, scene, parent, nameTag) {
            ...
            if (acp.easing) {
                this.easing = _parseMotion(acp.easing, {}, ABeamer._expressionEasing, ABeamer._easingFunctions, story._args);
            }
            else if (parent) {
                this.easing = parent.easing;
            }
            if (acp.oscillator) {
                this.oscillator = _parseMotion(acp.oscillator.handler, acp.oscillator.params, ABeamer._expressionEasing, ABeamer._easingFunctions, story._args);
            }
            else if (parent) {
                this.oscillator = parent.oscillator;
            }
            if (acp.path) {
                this.path = _parseMotion(acp.path.handler, acp.path.params, undefined, ABeamer._pathFunctions, story._args);
            }
            else if (parent) {
