...
(function (BuildDocs) {
     ...
     *
     */
    function buildMarkdownFromSourceFile(inpFileName, outFileName, apiFileName, moduleTypes, mkDocsYml, mkDocsOpts, localWebLinks, isEndUser) {
    ...
    function build(libModules, pluginModules) {
        ...
        BuildDocs.targets.forEach(function (target) {
            ...
            [['abeamer-cli', 'cli/abeamer-cli.ts', ''],
                ...
                buildMarkdownFromSourceFile(srcFileName, dstFileName, baseDstPath + "/" + BuildDocs.API_FOLDER + "/" + fileTitle + ".txt", target.moduleTypes, mkDocsYml, { folder: folder }, localWebLinks, target.isEndUser);
            });
