...
(function (BuildDTsFilesABeamer) {
    function build(libModules, pluginModules, CLIENT_UUID, COPYRIGHTS) {
        var WARN_MSG = "\n  // This file was generated via gulp build-definition-files\n  //\n  // @WARN: Don't edit this file.\n  ";
        var libSourceFileNames = libModules
            .map(function (fileTitle) { return dev_paths_js_1.DevPaths.JS_PATH + "/" + fileTitle + ".ts"; }).concat(pluginModules
            .map(function (fileTitle) { return dev_paths_js_1.DevPaths.PLUGINS_PATH + "/" + fileTitle + "/" + fileTitle + ".ts"; }));
        [{
                uuid: 'bb85cc57-f5e3-4ae9-b498-7d13c07c8516',
                srcFiles: libSourceFileNames,
                docTarget: build_docs_js_1.BuildDocs.targets.find(function (target) { return target.id === 'end-user'; }),
                namespace: 'ABeamer',
                outFile: dev_paths_js_1.DevPaths.TYPINGS_PATH + "/abeamer.d.ts",
            ...
            },
            {
                ...
                srcFiles: libSourceFileNames,
                namespace: 'ABeamer',
                docTarget: build_docs_js_1.BuildDocs.targets.find(function (target) { return target.id === 'dev'; }),
                outFile: dev_paths_js_1.DevPaths.TYPINGS_PATH + "/abeamer-dev.d.ts",
            ...
            },
            {
                ...
                tag: 'release',
                namespace: 'ABeamer',
                outFile: dev_paths_js_1.DevPaths.TYPINGS_PATH + "/release/abeamer-release.d.ts",
